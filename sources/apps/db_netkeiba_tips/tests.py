...
class HorseRacingTipParserForPageYosoCPNarTest(TestCase):
    def test_new_tips(self):
        ...
        check_values("202444070902", "差追", 2, "Third")
        check_values("202444070902", "血統", 2, "First")
        check_values("202444070902", "上昇度", 3, "Second")
        check_values("202444070902", "逃先", 3, "Second")
        check_values("202444070902", "差追", 3, "Fourth")
        check_values("202444070902", "騎手", 4, "First")
        check_values("202444070902", "逃先", 5, "First")
        check_values("202444070902", "差追", 5, "First")
        check_values("202444070902", "逃先", 6, "Third")
        check_values("202444070902", "調教師", 6, "Fourth")
        check_values("202444070902", "上昇度", 8, "First")
        check_values("202444070902", "調教師", 8, "Second")
        check_values("202444070902", "騎手", 10, "Third")
        check_values("202444070902", "血統", 10, "Third")
        check_values("202444070902", "騎手", 11, "Second")
        check_values("202444070902", "血統", 11, "Second")
        check_values("202444070902", "騎手", 12, "Fourth")
        check_values("202444070902", "血統", 12, "Fourth")
        check_values("202444070902", "上昇度", 13, "Third")
        check_values("202444070902", "逃先", 13, "Fourth")
        check_values("202444070902", "差追", 13, "Second")
        check_values("202444070902", "調教師", 13, "First")
        check_values("202444070902", "上昇度", 14, "Fourth")
        check_values("202444070902", "調教師", 14, "Third")
        check_values("202444070902", "rising", 3, "First")
        check_values("202444070902", "rising", 5, "Second")
        check_values("202444070902", "rising", 8, "Third")
        check_values("202444070902", "rising", 13, "Fourth")
        check_values("202444070902", "precede", 1, "Fourth")
        check_values("202444070902", "precede", 3, "Second")
        check_values("202444070902", "precede", 5, "First")
        check_values("202444070902", "precede", 13, "Third")
        check_values("202444070902", "spurt", 3, "Second")
        check_values("202444070902", "spurt", 5, "First")
        check_values("202444070902", "spurt", 8, "Fourth")
        check_values("202444070902", "spurt", 13, "Third")
        check_values("202444070902", "jockey", 3, "Second")
        check_values("202444070902", "jockey", 5, "First")
        check_values("202444070902", "jockey", 8, "Third")
        check_values("202444070902", "jockey", 13, "Fourth")
        check_values("202444070902", "trainer", 3, "Fourth")
        check_values("202444070902", "trainer", 5, "Second")
        check_values("202444070902", "trainer", 8, "Third")
        check_values("202444070902", "trainer", 13, "First")
        check_values("202444070902", "pedigree", 3, "Second")
        check_values("202444070902", "pedigree", 5, "First")
        check_values("202444070902", "pedigree", 8, "Third")
        check_values("202444070902", "pedigree", 13, "Fourth")
...
class HorseRacingTipParserForPageYosoCPRaceTest(TestCase):
    def test_new_tips(self):
        ...
        check_values("202408040811", "上昇度", 1, "Second")
        check_values("202408040811", "差追", 1, "Second")
        check_values("202408040811", "調教師", 1, "Second")
        check_values("202408040811", "差追", 2, "Fourth")
        check_values("202408040811", "騎手", 2, "Second")
        check_values("202408040811", "逃先", 3, "Third")
        check_values("202408040811", "差追", 4, "Third")
        check_values("202408040811", "騎手", 4, "First")
        check_values("202408040811", "調教師", 4, "Third")
        check_values("202408040811", "逃先", 5, "First")
        check_values("202408040811", "上昇度", 6, "Fourth")
        check_values("202408040811", "調教師", 6, "Fourth")
        check_values("202408040811", "逃先", 7, "Fourth")
        check_values("202408040811", "騎手", 7, "Fourth")
        check_values("202408040811", "調教師", 8, "First")
        check_values("202408040811", "差追", 9, "First")
        check_values("202408040811", "血統", 9, "Second")
        check_values("202408040811", "上昇度", 10, "Third")
        check_values("202408040811", "騎手", 10, "Third")
        check_values("202408040811", "血統", 10, "First")
        check_values("202408040811", "血統", 11, "Third")
        check_values("202408040811", "血統", 12, "Fourth")
        check_values("202408040811", "上昇度", 13, "First")
        check_values("202408040811", "逃先", 13, "Second")
        check_values("202408040811", "rising", 1, "First")
        check_values("202408040811", "rising", 2, "Third")
        check_values("202408040811", "rising", 4, "Second")
        check_values("202408040811", "rising", 10, "Fourth")
        check_values("202408040811", "precede", 2, "Second")
        check_values("202408040811", "precede", 3, "Third")
        check_values("202408040811", "precede", 5, "First")
        check_values("202408040811", "precede", 13, "Fourth")
        check_values("202408040811", "spurt", 1, "Third")
        check_values("202408040811", "spurt", 2, "Second")
        check_values("202408040811", "spurt", 4, "First")
        check_values("202408040811", "spurt", 9, "Fourth")
        check_values("202408040811", "jockey", 1, "Third")
        check_values("202408040811", "jockey", 2, "Second")
        check_values("202408040811", "jockey", 4, "First")
        check_values("202408040811", "jockey", 12, "Fourth")
        check_values("202408040811", "trainer", 1, "Third")
        check_values("202408040811", "trainer", 2, "Second")
        check_values("202408040811", "trainer", 4, "First")
        check_values("202408040811", "trainer", 12, "Fourth")
        check_values("202408040811", "pedigree", 1, "Third")
        check_values("202408040811", "pedigree", 2, "First")
        check_values("202408040811", "pedigree", 4, "Second")
        check_values("202408040811", "pedigree", 12, "Fourth")
